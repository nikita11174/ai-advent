...
`0271bf8`. Exact contract — `docs/tasks/DAY-04.md`. Day 1–3 implementation/technical verification
завершены; их visual/submission items остаются отдельными pending действиями.
